...
class NewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subtitle' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created_at' => 1540064718,
                'updated_at' => 1540064718,
